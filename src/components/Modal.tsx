...
export default function Modal({ children }: { children: React.ReactNode }) {
  return (
    <>
      ...
      <section className="fixed inset-4 m-auto w-auto h-auto sm:inset-0 sm:aspect-[3/4] sm:h-[90vh] sm:min-h-[30rem] sm:max-h-[50rem] z-30 bg-transparent animate-fade-in-spin">
        {children}
      </section>
    </>
  );
